...
abstract class AppPalette {
  ...
  static const Color primaryColor = Color(0xFF71a49b);
  static const Color secondaryColor = Color(0xff56898a);
  static const Color successColor = Color(0xFF68a835);
  static const Color splashColor = Color.fromARGB(36, 154, 154, 154);
  static const Color shimmerHColors = Color.fromARGB(66, 212, 212, 212);
  static const Color splashColorMButton = Color.fromARGB(49, 98, 98, 98);
