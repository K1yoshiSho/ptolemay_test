...
class TalkerSettingsBottomSheetW extends StatefulWidget {
  ...
  @override
  State<TalkerSettingsBottomSheetW> createState() =>
      _TalkerSettingsBottomSheetWState();
}

class _TalkerSettingsBottomSheetWState
    extends State<TalkerSettingsBottomSheetW> {
  @override
  void initState() {
