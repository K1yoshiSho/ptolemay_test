                      ...
                      children: [
                        RichText(
                          text: TextSpan(
                            ...
                            children: const [
                              TextSpan(text: ' http запросов было сделано')
                            ],
                          ),
                        ),
                        RichText(
              ...
              if (errors.isNotEmpty) ...[
                ...
                SliverToBoxAdapter(
                  child: TalkerMonitorCardW(
                    ...
                    subtitle:
                        'Количество неразрешенных ошибок в приложении: ${errors.length}',
                    onTap: () =>
              ...
              if (exceptions.isNotEmpty) ...[
                ...
                SliverToBoxAdapter(
                  child: TalkerMonitorCardW(
                    ...
                    icon: Icons.error_outline_rounded,
                    subtitle:
                        'Количество неразрешенных исключении в приложении: ${exceptions.length}',
                    onTap: () =>
              ...
              if (warnings.isNotEmpty) ...[
                ...
                SliverToBoxAdapter(
                  child: TalkerMonitorCardW(
                    ...
                    subtitle:
                        'Количество предупреждении в приложении: ${warnings.length}',
                    onTap: () =>
              ...
              if (infos.isNotEmpty) ...[
                ...
                SliverToBoxAdapter(
                  child: TalkerMonitorCardW(
                    ...
                    subtitle:
                        'Количество информационных логов: ${infos.length}',
              ...
              if (verboseDebug.isNotEmpty) ...[
                ...
                SliverToBoxAdapter(
                  child: TalkerMonitorCardW(
                    ...
                    subtitle:
                        'Количество отладочных логов: ${verboseDebug.length}',
